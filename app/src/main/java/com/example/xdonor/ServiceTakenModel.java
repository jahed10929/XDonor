...
public class ServiceTakenModel {
    private String year, date, time, location, hospital, bloodgroup, lastDonation;

    public ServiceTakenModel(String year, String date, String time, String location, String hospital, String bloodgroup, String lastDonation) {
        this.year = year;
        this.date = date;
        this.time = time;
