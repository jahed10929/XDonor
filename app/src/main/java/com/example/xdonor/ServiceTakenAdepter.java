...
public class ServiceTakenAdepter extends RecyclerView.Adapter<ServiceTakenAdepter.ViewHolder> {
    ArrayList<ServiceTakenModel> donationViewModelArrayList;

    public ServiceTakenAdepter(ArrayList<ServiceTakenModel> donationViewModelArrayList) {
    ...
    @NotNull
    @Override
    public ServiceTakenAdepter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.donation_itame_view, parent, false);
        return new ServiceTakenAdepter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull ServiceTakenAdepter.ViewHolder holder, int position) {
