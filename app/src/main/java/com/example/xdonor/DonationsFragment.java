...
public class DonationsFragment extends Fragment {
    //blood rerueast api
    private String url = "https://jsonkeeper.com/b/OVPM";
    private RecyclerView donationView;
    ArrayList<DonationViewModel> donationViewModels;
    ...
    /**
     * patch current user donation json data From API
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            JSONArray jsonArray = jsonObject1.getJSONArray("my donation");
    ...
    private void setJsonData(JSONArray jsonArray) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            donationViewModels.add(new DonationViewModel(yer, dt, tim, loc, hos, bg, lastD));
        }
        //attach recyclerview with adapter
        donationView.setAdapter(new DonationViewAdapter(donationViewModels));
    }
}